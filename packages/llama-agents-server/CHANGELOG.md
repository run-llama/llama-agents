...
- 8916b75: Use the serializer from `Workflow(serializer=...)` or `WorkflowServer(serializer=...)` consistently for durable state and replay. The workflow setting takes precedence.
