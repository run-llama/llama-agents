...
class DurableParent(Workflow):
    child: Annotated[DurableChild, ChildWorkflow]
...
class DurableMid(Workflow):
    grand: Annotated[DurableGrandchild, ChildWorkflow]
...
class DurableGrandparent(Workflow):
    child: Annotated[DurableMid, ChildWorkflow]
...
class CarryParent(Workflow):
    child: Annotated[CarryChild, ChildWorkflow]
