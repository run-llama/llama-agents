...
| images.controlPlane.tag | string | `"0.12.4"` | Control plane image tag |
...
| images.operator.tag | string | `"0.11.2"` | Operator image tag |
...
| images.appserver.tag | string | `"0.12.0"` | Appserver image tag |
