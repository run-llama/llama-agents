...
| images.controlPlane.tag | string | `"0.12.5"` | Control plane image tag |
...
| images.operator.tag | string | `"0.11.3"` | Operator image tag |
...
| images.appserver.tag | string | `"0.12.1"` | Appserver image tag |
